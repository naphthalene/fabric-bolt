...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.task_regex'
        db.add_column(u'projects_project', 'task_regex',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.task_regex'
        db.delete_column(u'projects_project', 'task_regex')
